...
class NavTrail
{
    ...
    public static function trailFor(string $pageKey): array
    {
        ...
        $map = [
            ...
            'search' => [$home, ['label' => 'Content', 'url' => null], ['label' => 'Library search', 'url' => AdminPath::url('search')]],
            'redirects' => [$home, ['label' => 'Settings', 'url' => null], ['label' => 'Redirects', 'url' => AdminPath::url('redirects')]],
