...
<p>Download ready-made packs from Customize / General: <strong>Sample template</strong> and <strong>Play · Build · Sound</strong> (gaming / web / music) — or <code>/admin/customize/sample-style-pack?pack=play-build-sound</code>. Rebuild with <code>php cli/build_style_pack.php</code>. Pack CSS lives under <code>public/uploads/theme-packs/active/</code> and is included in normal backup/restore of uploads; settings keys live in <code>app_settings</code>.</p>
