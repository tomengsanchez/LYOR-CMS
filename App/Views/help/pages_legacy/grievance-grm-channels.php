<?php
/**
 * Help: Grievance → Options → GRM Channels
 */
?>
<div class="card mb-4">
    <div class="card-body">
        <h5 class="mb-2">GRM Channels</h5>
        <p class="mb-2">
            Defines how a grievance was received (boxes, help desk, hotline, etc.).
            On the grievance form, <strong>GRM Channel is required</strong> when options exist for the selected project
