...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Sidebar and footer widget areas for the public site. Drag ⋮⋮ to reorder.</p>
    </div>
</div>
                ...
                <div class="widget-row border rounded p-3 mb-3" data-index="<?= (int)$idx ?>">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-4 widget-config-fields">
                            ...
                            <?php elseif (($w->widget_type ?? '') === 'recent_posts'): ?>
                            <label class="form-label small">Posts to show</label>
                            <input type="number" class="form-control form-control-sm widget-field-count" min="1" max="10" value="<?= (int)($cfg['count'] ?? 5) ?>">
                            <?php else: ?>
